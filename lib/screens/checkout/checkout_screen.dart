...
class CheckoutScreen extends StatefulWidget {
  final List<CheckoutItem>? preFilteredItems;
  const CheckoutScreen({super.key, this.preFilteredItems});
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    if (widget.preFilteredItems != null) {
      return PopScope(
        ...
        child: Scaffold(
          ...
          body: widget.preFilteredItems!.isEmpty
              ? Center(
                  child: Text(
                    "No items available for checkout.",
                    style: GoogleFonts.manrope(fontSize: 16, color: const Color(0xff8D7B7B)),
                  ),
                )
              : _buildCheckoutBody(widget.preFilteredItems!, 0.0),
        ),
      );
    }
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (buyNowItem != null) {
              return _buildCheckoutBody([buyNowItem], 0.0);
            }
            ...
            return StreamBuilder<List<DocumentSnapshot>>(
              stream: _streamAllProductsStock(cartDocs),
              builder: (context, stockSnapshot) {
                ...
                return _buildCheckoutBody(checkoutItems, 0.0);
              },
            );
          },
        ),
  ...
  Widget _buildCheckoutBody(List<CheckoutItem> checkoutItems, double deliveryFee) {
  ...
  Stream<List<DocumentSnapshot>> _streamAllProductsStock(
    ...
    if (cartDocs.isEmpty) return Stream.value([]);
    List<Stream<DocumentSnapshot>> streams = cartDocs.map((item) {
